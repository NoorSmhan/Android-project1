...
//        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://localhost/school_api/add_subject.php",
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://10.0.2.2/school_api/add_subject.php",

                response -> {
                    // التعامل مع الرد من السيرفر
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("subject_name", subjectName);  // تأكد من أنه لا يوجد نقص في الفواصل
